...
export default function HomePage() {
  return (
    <div className="space-y-32">
      {/* Hero Section - Bold Visual Impact */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* Large Background Image as Design Element */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-6 pt-8">
                <Button asChild className="bg-blue-600 hover:bg-blue-500 text-white border-0 rounded-full px-8 py-4 text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-600/30 hover:shadow-blue-600/50">
                  <Link href="/nightly/design-b/cases">Explore Our Work</Link>
                </Button>
                <Button asChild className="bg-transparent border-2 border-blue-400 text-blue-400 hover:bg-blue-600/10 hover:border-blue-300 hover:text-blue-300 rounded-full px-8 py-4 text-lg transition-all duration-300 hover:scale-105">
                  <Link href="/nightly/design-b/contact">Get in Touch</Link>
                </Button>
              </div>
            </div>
            ...
            <div className="lg:col-span-4 flex justify-center items-center">
              <div className="relative">
                <div className="w-72 h-72 bg-gradient-to-br from-blue-600/20 to-blue-400/30 rounded-full blur-3xl animate-pulse"></div>
                <div className="absolute inset-0 w-64 h-64 bg-gradient-to-tr from-blue-500/30 to-blue-300/40 rounded-full blur-2xl animate-pulse delay-1000 m-4"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5">
              <div className="relative">
                <div className="aspect-square bg-gradient-to-br from-blue-600/20 to-blue-400/10 rounded-none border border-blue-600/30 p-12 backdrop-blur-sm">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => {
              ...
              return (
                <Card key={service.id} className={`bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm shadow-lg rounded-none group hover:shadow-xl hover:shadow-blue-900/30 transition-all duration-500 hover:border-blue-600/40 hover:bg-slate-800/60 hover:scale-105 hover:-translate-y-2 ${isOffset ? 'lg:mt-8' : ''}`}>
                  <CardHeader className="p-8">
                    <div className="w-16 h-16 bg-gradient-to-br from-blue-600/30 to-blue-400/30 rounded-none flex items-center justify-center mb-6 group-hover:from-blue-500/40 group-hover:to-blue-300/40 transition-all duration-300 group-hover:scale-110">
          ...
          <div className="text-center mt-16">
            <Button asChild className="bg-blue-600 hover:bg-blue-500 text-white border-0 rounded-full px-8 py-4 text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-600/30 hover:shadow-blue-600/50">
              <Link href="/nightly/design-b/services">View All Services</Link>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {sectors.map((sector, index) => {
              ...
              return (
                <Card key={sector.id} className="bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm shadow-lg rounded-none group hover:shadow-2xl hover:shadow-blue-900/30 transition-all duration-500 hover:border-blue-500/50 hover:scale-105 hover:-translate-y-2 relative overflow-hidden">
                  {/* Animated Background */}
          ...
          <div className="text-center mt-16">
            <Button asChild className="bg-blue-600 hover:bg-blue-500 text-white border-0 rounded-full px-8 py-4 text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-600/30 hover:shadow-blue-600/50">
              <Link href="/nightly/design-b/sectors">Explore All Sectors</Link>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {geographies.map((geography, index) => (
              <Card key={geography.country} className="bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm shadow-lg rounded-none group hover:shadow-2xl hover:shadow-blue-900/30 transition-all duration-500 hover:border-blue-500/50 relative overflow-hidden hover:scale-105 hover:-translate-y-2">
          ...
          <div className="text-center mt-16">
            <Button asChild className="bg-blue-600 hover:bg-blue-500 text-white border-0 rounded-full px-8 py-4 text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-600/30 hover:shadow-blue-600/50">
              <Link href="/nightly/design-b/geographies">View All Locations</Link>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {agencies.slice(0, 4).map((agency, index) => (
              <Card key={agency.id} className="bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm shadow-lg rounded-none group hover:shadow-2xl hover:shadow-blue-900/30 transition-all duration-500 hover:border-blue-500/50 overflow-hidden hover:scale-105 hover:-translate-y-2">
          ...
          <div className="text-center mt-16">
            <Button asChild className="bg-blue-600 hover:bg-blue-500 text-white border-0 rounded-full px-8 py-4 text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-600/30 hover:shadow-blue-600/50">
              <Link href="/nightly/design-b/agencies">Meet All Agencies</Link>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {cases.slice(0, 6).map((caseItem, index) => {
              ...
              return (
                <Card key={caseItem.id} className={`bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm shadow-lg rounded-none group hover:shadow-2xl hover:shadow-blue-900/30 transition-all duration-500 hover:border-blue-500/50 overflow-hidden hover:scale-105 hover:-translate-y-4 ${isLarge ? 'md:col-span-1 lg:row-span-2' : ''}`}>
          ...
          <div className="text-center mt-16">
            <Button asChild className="bg-blue-600 hover:bg-blue-500 text-white border-0 rounded-full px-8 py-4 text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-600/30 hover:shadow-blue-600/50">
              <Link href="/nightly/design-b/cases">View All Cases</Link>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {people.slice(0, 8).map((person, index) => (
              <Card key={person.id} className="bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm shadow-lg rounded-none group hover:shadow-xl hover:shadow-blue-900/30 transition-all duration-500 hover:border-blue-500/50 text-center overflow-hidden hover:scale-105 hover:-translate-y-2">
          ...
          <div className="text-center mt-16">
            <Button asChild className="bg-blue-600 hover:bg-blue-500 text-white border-0 rounded-full px-8 py-4 text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-600/30 hover:shadow-blue-600/50">
              <Link href="/nightly/design-b/team">Meet Everyone</Link>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {news.slice(0, 3).map((newsItem, index) => {
              ...
              return (
                <Card key={newsItem.id} className={`bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm shadow-lg rounded-none group hover:shadow-2xl hover:shadow-blue-900/30 transition-all duration-500 hover:border-blue-500/50 overflow-hidden hover:scale-105 hover:-translate-y-4 ${isFeatured ? 'md:col-span-2 lg:col-span-1 lg:row-span-2' : ''}`}>
                  {/* Enhanced Image Display */}
                  <div className={`${isFeatured ? 'aspect-[4/3]' : 'aspect-video'} relative overflow-hidden`}>
                    <Image 
                      src={newsItem.image} 
                      alt={newsItem.title}
                      fill
          ...
          <div className="text-center mt-16">
            <Button asChild className="bg-blue-600 hover:bg-blue-500 text-white border-0 rounded-full px-8 py-4 text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-600/30 hover:shadow-blue-600/50">
              <Link href="/nightly/design-b/news">All News</Link>
            </Button>
          </div>
        </div>
      </section>
