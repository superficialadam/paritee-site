...
const sitemap = [
  { name: 'Home', href: '/nightly/base' },
  { name: 'Services', href: '/nightly/base/services' },
  { name: 'Sectors', href: '/nightly/base/sectors' },
  { name: 'Geographies', href: '/nightly/base/geographies' },
  { name: 'Agencies', href: '/nightly/base/agencies' },
  { name: 'Cases', href: '/nightly/base/cases' },
  { name: 'Team', href: '/nightly/base/team' },
  { name: 'News', href: '/nightly/base/news' },
  { name: 'Contact', href: '/nightly/base/contact' },
]
