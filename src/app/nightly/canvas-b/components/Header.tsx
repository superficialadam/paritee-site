...
const navigation = [
  { name: 'Home', href: '/nightly/canvas-b' },
  { name: 'Services', href: '/nightly/canvas-b/services' },
  { name: 'Sectors', href: '/nightly/canvas-b/sectors' },
  { name: 'Geographies', href: '/nightly/canvas-b/geographies' },
  { name: 'Agencies', href: '/nightly/canvas-b/agencies' },
  { name: 'Cases', href: '/nightly/canvas-b/cases' },
  { name: 'Team', href: '/nightly/canvas-b/team' },
  { name: 'News', href: '/nightly/canvas-b/news' },
  { name: 'Contact', href: '/nightly/canvas-b/contact' },
]
