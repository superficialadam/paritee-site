    ...
    <div className="space-y-40">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          >
            <Button asChild className="bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 transition-all duration-300 hover:scale-105 motion-reduce:hover:scale-100 transform-gpu">
              <Link href="/nightly/canvas-a/cases">Explore Our Work</Link>
            </Button>
            <Button asChild className="bg-transparent border border-slate-600 text-slate-300 hover:bg-slate-600/10 hover:border-slate-500 rounded-full px-6 py-3 transition-all duration-300 hover:scale-105 motion-reduce:hover:scale-100 transform-gpu">
              <Link href="/nightly/canvas-a/contact">Get in Touch</Link>
            </Button>
          </motion.div>
        </div>
      </motion.section>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            <Button asChild className="bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 transition-all duration-300 hover:scale-105 motion-reduce:hover:scale-100 transform-gpu">
              <Link href="/nightly/canvas-a/services">View All Services</Link>
            </Button>
          </motion.div>
        </div>
      </motion.section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-16">
            <Button asChild className="bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 transition-all duration-300">
              <Link href="/nightly/canvas-a/sectors">Explore All Sectors</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="px-8 py-24">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-16">
            <Button asChild className="bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 transition-all duration-300">
              <Link href="/nightly/canvas-a/geographies">View All Locations</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="px-8 py-24">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-16">
            <Button asChild className="bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 transition-all duration-300">
              <Link href="/nightly/canvas-a/agencies">Meet All Agencies</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            <Button asChild className="bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 transition-all duration-300 hover:scale-105 motion-reduce:hover:scale-100 transform-gpu">
              <Link href="/nightly/canvas-a/cases">View All Cases</Link>
            </Button>
          </motion.div>
        </div>
      </motion.section>
      ...
      <section className="px-8 py-24">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-16">
            <Button asChild className="bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 transition-all duration-300">
              <Link href="/nightly/canvas-a/team">Meet Everyone</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="px-8 py-24">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-16">
            <Button asChild className="bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 transition-all duration-300">
              <Link href="/nightly/canvas-a/news">All News</Link>
            </Button>
          </div>
        </div>
      </section>
