...
const sitemap = [
  { name: 'Home', href: '/nightly/canvas-c' },
  { name: 'Services', href: '/nightly/canvas-c/services' },
  { name: 'Sectors', href: '/nightly/canvas-c/sectors' },
  { name: 'Geographies', href: '/nightly/canvas-c/geographies' },
  { name: 'Agencies', href: '/nightly/canvas-c/agencies' },
  { name: 'Cases', href: '/nightly/canvas-c/cases' },
  { name: 'Team', href: '/nightly/canvas-c/team' },
  { name: 'News', href: '/nightly/canvas-c/news' },
  { name: 'Contact', href: '/nightly/canvas-c/contact' },
]
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-8 mb-8 sm:mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link href="/nightly/canvas-c" className="inline-block mb-4">
