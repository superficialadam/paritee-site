...
const navigation = [
  { name: 'Home', href: '/nightly/canvas-c', icon: Home },
  { name: 'Services', href: '/nightly/canvas-c/services', icon: Briefcase },
  { name: 'Sectors', href: '/nightly/canvas-c/sectors', icon: Building2 },
  { name: 'Geographies', href: '/nightly/canvas-c/geographies', icon: Globe },
  { name: 'Agencies', href: '/nightly/canvas-c/agencies', icon: Users },
  { name: 'Cases', href: '/nightly/canvas-c/cases', icon: FolderOpen },
  { name: 'Team', href: '/nightly/canvas-c/team', icon: UserCheck },
  { name: 'News', href: '/nightly/canvas-c/news', icon: Newspaper },
  { name: 'Contact', href: '/nightly/canvas-c/contact', icon: Phone },
]
