...
export default function HomePage() {
  return (
    <div className="space-y-16 sm:space-y-24 lg:space-y-32 motion-layout-batch">
      ...
      <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center space-y-6 sm:space-y-8">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-semibold text-white leading-tight max-w-4xl mx-auto motion-text-reveal" style={{"--text-delay": "0ms"}}>
            ...
            <div className="space-y-4 sm:space-y-6 max-w-3xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-slate-200 leading-relaxed font-medium motion-text-reveal" style={{"--text-delay": "100ms"}}>
              ...
              <div className="space-y-4 text-base sm:text-lg text-slate-300 leading-relaxed">
                ...
                <p className="text-lg sm:text-xl text-blue-200 font-medium motion-text-reveal" style={{"--text-delay": "200ms"}}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8 sm:mt-12">
              <Button asChild className="w-full sm:w-auto bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 sm:px-8 sm:py-4 font-semibold text-lg min-h-[48px] focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-slate-950 motion-button motion-focus">
                <Link href="/nightly/motion-c/cases" className="flex items-center justify-center space-x-2">
                  <span>Explore Our Work</span>
                  <ChevronRight className="w-4 h-4" />
                </Link>
              </Button>
              <Button asChild className="w-full sm:w-auto bg-transparent border border-slate-600 text-slate-300 hover:bg-slate-600/10 hover:border-slate-500 rounded-full px-6 py-3 sm:px-8 sm:py-4 min-h-[48px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-950 motion-button motion-focus">
                <Link href="/nightly/motion-c/contact" className="flex items-center justify-center space-x-2">
          ...
          <div className="mt-12 sm:mt-16 lg:mt-20">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-center">
              <div className="bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm rounded-none p-6 hover:border-blue-600/30 motion-card motion-stagger-item" style={{"--stagger-delay": "0ms"}}>
                <div className="flex items-center justify-center mb-2">
                  <Star className="w-6 h-6 text-blue-400 mr-2 motion-card-icon" />
                  <span className="text-2xl font-semibold text-white">25+</span>
                </div>
                <p className="text-slate-400 text-sm">Top-tier agencies</p>
              </div>
              <div className="bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm rounded-none p-6 hover:border-blue-600/30 motion-card motion-stagger-item" style={{"--stagger-delay": "100ms"}}>
                <div className="flex items-center justify-center mb-2">
                  <Users className="w-6 h-6 text-blue-400 mr-2 motion-card-icon" />
                  <span className="text-2xl font-semibold text-white">500+</span>
                </div>
                <p className="text-slate-400 text-sm">Expert professionals</p>
              </div>
              <div className="bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm rounded-none p-6 hover:border-blue-600/30 motion-card motion-stagger-item" style={{"--stagger-delay": "200ms"}}>
                <div className="flex items-center justify-center mb-2">
                  <Award className="w-6 h-6 text-blue-400 mr-2 motion-card-icon" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mb-8 sm:mb-12">
              <Card className="bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm shadow-lg rounded-none hover:border-blue-600/30 p-6 motion-card motion-stagger-item" style={{"--stagger-delay": "0ms"}}>
                <div className="text-center space-y-4">
                  <div className="w-12 h-12 bg-blue-600/20 rounded-full flex items-center justify-center mx-auto motion-card-icon">
              ...
              <Card className="bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm shadow-lg rounded-none hover:border-blue-600/30 p-6 motion-card motion-stagger-item" style={{"--stagger-delay": "100ms"}}>
                <div className="text-center space-y-4">
                  <div className="w-12 h-12 bg-blue-600/20 rounded-full flex items-center justify-center mx-auto motion-card-icon">
              ...
              <Card className="bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm shadow-lg rounded-none hover:border-blue-600/30 p-6 motion-card motion-stagger-item" style={{"--stagger-delay": "200ms"}}>
                <div className="text-center space-y-4">
                  <div className="w-12 h-12 bg-blue-600/20 rounded-full flex items-center justify-center mx-auto motion-card-icon">
      ...
      <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {services.slice(0, 6).map((service, index) => {
              ...
              return (
                <Card 
                  key={service.id} 
                  className="bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm shadow-lg rounded-none group hover:shadow-xl hover:shadow-slate-900/50 hover:border-blue-600/30 hover:bg-slate-800/60 cursor-pointer min-h-[200px] sm:min-h-[220px] motion-card motion-stagger-item motion-focus"
                ...
                >
                  <CardHeader className="p-4 sm:p-6">
                    <div className="w-12 h-12 bg-blue-600/20 rounded-full flex items-center justify-center mb-4 group-hover:bg-blue-600/30 motion-card-icon">
                      {IconComponent && <IconComponent className="w-6 h-6 text-blue-400" />}
                    </div>
                    <CardTitle className="text-lg sm:text-xl font-medium text-white group-hover:text-blue-100 transition-colors duration-200">
                      {service.name}
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="px-4 pb-4 sm:px-6 sm:pb-6">
                    <CardDescription className="text-slate-400 leading-relaxed text-sm sm:text-base group-hover:text-slate-300 transition-colors duration-200">
                      {service.blurb}
                    </CardDescription>
                  </CardContent>
                </Card>
          ...
          <div className="text-center mt-8 sm:mt-12">
            <Button asChild className="w-full sm:w-auto bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 sm:px-8 sm:py-4 font-semibold min-h-[48px] focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-slate-950 motion-button motion-focus">
              <Link href="/nightly/motion-c/services" className="flex items-center justify-center space-x-2">
      ...
      <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-8 sm:mt-12">
            <Button asChild className="w-full sm:w-auto bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 sm:px-8 sm:py-4 font-semibold min-h-[48px] focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-slate-950 motion-button motion-focus">
              <Link href="/nightly/motion-c/sectors" className="flex items-center justify-center space-x-2">
      ...
      <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-12">
            <Button asChild className="w-full sm:w-auto bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 sm:px-8 sm:py-4 font-semibold min-h-[48px] focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-slate-950 motion-button motion-focus">
              <Link href="/nightly/motion-c/geographies" className="flex items-center justify-center space-x-2">
      ...
      <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-12">
            <Button asChild className="w-full sm:w-auto bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 sm:px-8 sm:py-4 font-semibold min-h-[48px] focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-slate-950 motion-button motion-focus">
              <Link href="/nightly/motion-c/agencies" className="flex items-center justify-center space-x-2">
      ...
      <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-12">
            <Button asChild className="w-full sm:w-auto bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 sm:px-8 sm:py-4 font-semibold min-h-[48px] focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-slate-950 motion-button motion-focus">
              <Link href="/nightly/motion-c/team" className="flex items-center justify-center space-x-2">
      ...
      <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mt-12">
            <Button asChild className="w-full sm:w-auto bg-transparent border border-blue-600 text-blue-400 hover:bg-blue-600/10 hover:border-blue-500 rounded-full px-6 py-3 sm:px-8 sm:py-4 font-semibold min-h-[48px] focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-slate-950 motion-button motion-focus">
              <Link href="/nightly/motion-c/news" className="flex items-center justify-center space-x-2">
                <span>All News</span>
                <ChevronRight className="w-4 h-4" />
              </Link>
            </Button>
