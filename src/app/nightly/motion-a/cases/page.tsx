...
// Animation variants for sophisticated reveals
          ...
          <AnimatePresence>
            {showFilters && (
              <motion.div 
                ...
                className="bg-slate-800/40 border border-slate-700/50 rounded-none p-6 mb-8 overflow-hidden"
              >
                <motion.div 
                ...
                >
                  ...
                  <motion.div variants={cardVariants}>
                    ...
                    <select 
                      ...
                      className="w-full px-3 py-2 bg-slate-700/50 border border-slate-600 rounded-full text-white focus:outline-none focus:border-blue-600/60 focus:ring-2 focus:ring-blue-600/20 transition-all duration-300 focus:bg-slate-700/70 hover:bg-slate-700/60"
                    >
                  ...
                  >
                    <Card className="bg-slate-800/40 border border-slate-700/50 backdrop-blur-sm shadow-lg rounded-none group hover:shadow-xl hover:shadow-slate-900/50 transition-all duration-300 hover:border-slate-600/60 overflow-hidden hover:-translate-y-1 motion-reduce:hover:-translate-y-0 hover:scale-102 motion-reduce:hover:scale-100 transform-gpu">
                      ...
                      <CardHeader className="p-6">
                        <CardTitle className="text-lg font-medium text-white mb-2 group-hover:text-blue-100 transition-colors duration-300">{caseItem.name}</CardTitle>
                        <div className="flex flex-wrap gap-2 mb-3">
                          <span className="px-2 py-1 bg-blue-600/20 text-blue-400 border border-blue-600/40 text-xs rounded-full hover:bg-blue-600/30 transition-colors duration-300">
                            {getSectorName(caseItem.sectorId)}
                          </span>
                          <span className="px-2 py-1 bg-emerald-600/20 text-emerald-400 border border-emerald-600/40 text-xs rounded-full hover:bg-emerald-600/30 transition-colors duration-300">
                            {getServiceName(caseItem.serviceId)}
                          </span>
                        </div>
                      </CardHeader>
                      <CardContent className="px-6 pb-6">
                        <CardDescription className="text-slate-400 leading-relaxed text-sm mb-4 group-hover:text-slate-300 transition-colors duration-300">
                          {caseItem.excerpt}
                        </CardDescription>
                        <div className="flex items-center justify-between">
                          ...
                          <Button variant="ghost" className="text-blue-400 hover:text-blue-300 p-0 h-auto font-normal text-sm hover:scale-105 motion-reduce:hover:scale-100 transform-gpu transition-transform duration-300">
                            Read Full Case
                          </Button>
                        </div>
                      </CardContent>
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button asChild className="bg-transparent border border-slate-600 text-slate-300 hover:bg-slate-600/10 hover:border-slate-500 rounded-full px-6 py-3 transition-all duration-300 hover:scale-105 motion-reduce:hover:scale-100 transform-gpu">
              <Link href="/nightly/motion-a/services">Our Services</Link>
            </Button>
          </div>
        </div>
      </section>
