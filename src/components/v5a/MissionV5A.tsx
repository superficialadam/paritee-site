...
const MissionV5A = () => {
  ...
  const missionStatements = [
    {
      text: "We didn't build Paritee to chase size. We built it to deliver the impact you deserve — with trust, purpose and partnership at the core and most importantly, customized to your needs.",
      emphasis: "customized to your needs"
    },
    {
      text: "You won't find hierarchies or holding company politics here. You'll find equals — independent agencies with aligned values, coming together to solve real challenges with sharp thinking and shared ambition.",
      emphasis: "equals"
    },
    {
      text: "Our name, Paritee, is rooted in the idea of parity. It reflects what we believe: Great things happen when equals come together. Each of our agencies is a recognized leader in its market — strong individually, even stronger together.",
      emphasis: "Great things happen when equals come together"
    },
    {
      text: "You get seamless delivery, sharper thinking, and results without the baggage of big networks or the limits of small shops.",
      emphasis: "seamless delivery, sharper thinking, and results"
    }
  ]
