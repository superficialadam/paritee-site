    ...
    const sketch = (p: p5) => {
      p.setup = () => {
        ...
        for (let i = 0; i < 5; i++) {
          const blob: Blob = {
            ...
            vertices: [],
            color: i % 3 === 0 ? '#3B82F6' : i % 3 === 1 ? '#1D4ED8' : '#60A5FA',
      ...
      p.draw = () => {
        ...
        blobs.forEach((blob, index) => {
          ...
          if (blob.color === '#3B82F6') {
            p.fill(59, 130, 246, blob.opacity * 255)
          } else if (blob.color === '#1D4ED8') {
            p.fill(29, 78, 216, blob.opacity * 255)
          } else {
            p.fill(96, 165, 250, blob.opacity * 255)
          }
          p.noStroke()
...
export default P5BackgroundV5A