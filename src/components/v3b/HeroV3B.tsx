export default function HeroV3B() {
  return (
    <section className="min-h-screen flex items-center justify-center">
      <div className="container max-w-5xl text-center px-8">
        <h1 className="relative">
          <span className="absolute inset-0 shimmer-text-dark" />
          <span className="relative text-6xl md:text-8xl lg:text-9xl font-light font-heading tracking-tighter leading-none text-white">
